...
Patch1:         gnutls_error_test_fix.patch
...
%changelog
* Thu Jun 24 2021 Thomas Crain <thcrain@microsoft.com> - 2.59.1-8
- Add patch to fix package test error caused by nettle upgrade.
